...
''';
  ...
  static String _getSignaturesSection(LegalContractData data) {
    final buffer = StringBuffer();
    buffer.writeln('المادة الرابعة: التواقيع');
    buffer.writeln('');
  ...
  static String _getCapacityLabel(LegalCapacity c) {
    switch (c) {
      case LegalCapacity.individual: return 'أصيل';
      case LegalCapacity.guardian: return 'وصي شرعي';
      case LegalCapacity.agent: return 'وكيل';
      case LegalCapacity.legalEntity: return 'شخص اعتباري';
      default: return 'أصيل';
    }
  }
