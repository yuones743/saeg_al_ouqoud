      ...
      body: ListView(
        ...
        children: [
          _StatusBanner(
            ...
            warningCount: warningDecisions.length + validationFailures.where((f) => f.severity == 'warning').length,
          ),
          ...
          ElevatedButton.icon(
            ...
            label: const Text('معاينة العقد وتصديره', style: TextStyle(fontSize: 16)),
...
// ✅ هذا هو الكلاس الذي تم إصلاحه بالكامل (السطر 117 كان به خطأ)
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        // ✅ السطر التالي كان به خطأ (أقواس زائدة) وتم إصلاحه
        subtitle: Text('القاعدة: ${decision.ruleId}', style: const TextStyle(fontSize: 10, color: Colors.grey)),
        dense: true,
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(failure.messageAr, style: const TextStyle(fontSize: 13)),
        dense: true,
      ),
    );
  }
