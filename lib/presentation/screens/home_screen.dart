      ...
      body: ListView(
        ...
        children: [
          ...
          _btn(
            ...
            () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const QuickContractWizard()),
            ),
          ),
          const SizedBox(height: 12),
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const SmartContractWizard()),
        ),
        borderRadius: BorderRadius.circular(8),
        child: Padding(
          padding: const EdgeInsets.all(16),
              ...
              Expanded(
                child: Column(
                  ...
                  children: const [
                    ...
                    Text(
                      'أنشئ عقوداً قانونية مرنة بأطراف متعددة',
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 6),
          Text(
            'نظام قرارات قانونية – أوفلاين بالكامل',
            textAlign: TextAlign.center,
            style: TextStyle(color: Colors.white70, fontSize: 12),
          ),
        ],
